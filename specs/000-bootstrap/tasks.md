...
- [X] T048 [US3] Run the SC-008 fixture for real: branch `spike/sc-008-shell-fixture`, add the shell `COPY` to `apps/coire-api/docker/api.Dockerfile`, push, capture the failing `image-policy` log line into `docs/runbooks/bootstrap.md`, delete the branch
